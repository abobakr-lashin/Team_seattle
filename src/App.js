    ...
    <div>
      <HashRouter>
        ...
        <Routes>
          ...
          <Route
            path="Areas/Buy/category/Location/:id"
            element={<PageAreasbuy />}
          />
          <Route
            path="Areas/Rent/category/Location/:id"
            element={<PageAreasRent />}
          />
          <Route path="Areas/location/center/:id" element={<AreasCategory />} />

          <Route
            path="/Areas/Category/Location/Center/:id"
            element={<CategoryAreas />}
          />
          <Route path="BuyHome" element={<BuyHome />} />
          <Route path="Developers/:id" element={<Developers />} />
          <Route
            path="/Buy/Category/Location/:id"
            element={<CategoryDeveloper />}
          />
          ...
          <Route
            path="/Seattle/category/:id"
            element={<CategoryOffPlanSeattle />}
          />
          {/* End Path Commercial */}
          <Route path="dashboard" element={<Dashboard />}>
            ...
            <Route
              path="AddCategoryBuyLocation"
              element={<AddCateBuyLocation />}
            />
            ...
            <Route
              path="/dashboard/Developers/AddDevelopers"
              element={<AddDevelopers />}
            />
            <Route
              path="AddCategoryRentPlan"
              element={<AddCategoryRentPlan />}
            />
            ...
            <Route
              path="Commercial/AddBannerCommercial"
              element={<AddBannerCommercial />}
            />
            ...
            <Route
              path="AddCategorySellPlan"
              element={<AddCategorySellPlan />}
            />
            ...
            <Route
              path="/dashboard/CreateSeattle"
              element={<CreateSheattle />}
            />
            <Route
              path="/dashboard/SeattleProject/EditSeattle/:id"
              element={<SeattleUpdate />}
            />
            <Route
              path="Developers/AddBannerDevelopers"
              element={<AddBannerDevelopers />}
            />
            <Route
              path="/dashboard/Developers/UpdateDevelopers/:id"
              element={<AddCartDevelopers />}
            />
          </Route>
        </Routes>
      </HashRouter>
