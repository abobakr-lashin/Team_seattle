...
import ClassicEditor from "@ckeditor/ckeditor5-build-classic";
import { CKEditor } from "@ckeditor/ckeditor5-react";
>>>>>>> c9b41da91c507b21706bf93bc80e4852719f4275
export default function AddCardBuy() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const fileRefBlog = ref(
        storage,
        `filesBlog/${formData.listingImage.name}`
      );
          ...
          <div className="form-group">
            <select
              ...
              onChange={(e) => {
                setFormData({
                  ...formData,
                  CategoryBuyLocation: e.target.value,
                });
              }}
            >
              <option hidden>Select Category Location</option>
          ...
          <div className="form-group">
            <select
              ...
              onChange={(e) => {
                setFormData({
                  ...formData,
                  CategoryDevelopers: e.target.value,
                });
              }}
            >
              <option hidden>Select Category Developers</option>
