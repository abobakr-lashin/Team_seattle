...
const AddCategorySellPlan = () => {
    ...
    const handleAddCategory = async (e) => {
        ...
        try {
            // Cheake Category 
            const categoriesRef = collection(firestore, 'categorySellPlan');
    ...
    return (
        <Box sx={{ maxWidth: 400, mx: 'auto', mt: 4, p: 2, border: '1px solid #ccc', borderRadius: 2 }}>
            <Typography variant="h5" sx={{ mb: 2 }}>Add Category Sell Plan</Typography>
            ...
            <div className="form-group">
                <select style={{ margin: '20px', width: '80%' }} name="category" onChange={(e) => {
                    ...
                    <option value={'Landlords Tools'}>Landlords Tools</option>
                </select>
            </div>
            <List>
...
export default AddCategorySellPlan;
