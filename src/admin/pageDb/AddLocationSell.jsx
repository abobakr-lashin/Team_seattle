...
const AddLocationSell = () => {
    ...
    const handleAddCategory = async (e) => {
        ...
        try {
            // Cheake Category 
            const categoriesRef = collection(firestore,  'CategorySellLocation');
    ...
    return (
        <Box sx={{ maxWidth: 400, mx: 'auto', mt: 4, p: 2, border: '1px solid #ccc', borderRadius: 2 }}>
            <Typography variant="h5" sx={{ mb: 2 }}>Add Category Location Sell</Typography>
...
export default AddLocationSell;
