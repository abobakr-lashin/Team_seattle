...
export default function ServiceDetails() {
  ...
  const ServiceDetails = [
    ...
    },
    {
      ...
      p1: `Accurate property valuation is crucial for making informed real estate decisions. At Seattle & Middle East, we offer comprehensive valuation services that provide a clear understanding of your property's true market value, whether you're in Seattle or the Middle East.`,
      p2: `Seattle Property Valuation:Our valuation experts in Seattle combine local market knowledge with advanced analytical tools to deliver precise and reliable property assessments. Whether you're looking to buy, sell, or refinance, our detailed reports offer insights that help you make strategic decisions. We evaluate factors such as location, market trends, and property condition to ensure a fair and accurate valuation.`,
      p3: `Middle East Property Valuation:In the Middle East, our property valuation services are tailored to reflect the region's dynamic and diverse real estate market. We provide valuations for residential, commercial, and industrial properties, utilizing a deep understanding of local market conditions, regulatory requirements, and cultural nuances. Our goal is to give you a transparent and dependable valuation that supports your investment or sales strategy.`,
      p4: `With a commitment to accuracy and integrity, Seattle property valuation services in Seattle and the Middle East ensure that you have the essential information needed to maximize the value of your real estate assets.`,
      p5: ``,
      data: ``,
    ...
    },
    {
      ...
      p1: `At Seattle & Middle East, we provide a curated selection of property listings tailored to meet your unique needs. Whether you're searching for your dream home, a lucrative investment, or commercial space, our comprehensive listings offer a wide range of options in both Seattle and the UAE.`,
      p3: `Seattle Property Listings:Our Seattle property listings showcase an array of residential and commercial properties across the city's most sought-after neighborhoods. From charming suburban homes to luxurious downtown condos, we offer properties that cater to diverse lifestyles and budgets. Each listing is accompanied by detailed information, high-quality images, and virtual tours, allowing you to explore your options from the comfort of your home.`,
      p5: `UAE Property Listings:In the UAE, our listings feature an extensive portfolio of properties, from modern apartments in the heart of Dubai to spacious villas in Abu Dhabi. We also offer a selection of commercial properties, including office spaces, retail units, and investment opportunities in key locations. Our UAE listings are regularly updated to reflect the latest market trends, ensuring you have access to the newest and most desirable properties available.`,
      data: ``,
      ...
      <div className="tow">
        <div className="OurPartners">
          ...
          >
            ...
            <div className="display2"     style={{ margin: "auto", width: "90%" ,whiteSpace: "pre-wrap" }} >
              <div className="">
