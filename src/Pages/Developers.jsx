...
export default function Developers() {
  ...
  const GetDataFireBase = async () => {
    try {
      ...
      console.log(docs);
      const fiterData = docs.filter(
        (it) => it.CategoryDevelopers.toUpperCase() === id.toUpperCase()
      );
          ...
          <div className="img-Abudhabi">
            ...
            <div className="dis">
              <div>
                <div className="btn-t">
                  <Link
                    to={`/Buy/Category/Location/${it.CateBuyLocation.location}`}
                  >
                    buy Property
                  </Link>
                </div>
  ...
  return (
    <div>
      <div className="OurPartners">
        ...
        >
          <div
            className="img-Developerss"
            style={{
              backgroundImage: `url(${categoryDevelopers[0]?.bannerCart})`,
            }}
          ></div>
          ...
          >
            ...
            >
              <img
                src="/uploads/commercial/export/northarrow.png"
                alt="Previous"
              />
            </div>
        ...
        <Grid sx={{ width: "100%" }} spacing={5}>
          ...
          >
            <img
              width={"35%"}
              style={{ margin: "15px" }}
              src={categoryDevelopers[0]?.banner1}
              alt=""
            />
            <img
              width={"20%"}
              style={{ margin: "15px" }}
              src={categoryDevelopers[0]?.banner2}
              alt=""
            />
            <img
              width={"20%"}
              style={{ margin: "15px" }}
              src={categoryDevelopers[0]?.banner3}
              alt=""
            />
          </Grid>
        </Grid>
        <Grid sx={{ width: "100%" }} spacing={5}>
          ...
          >
            <img
              width={"20%"}
              style={{ margin: "15px" }}
              src={categoryDevelopers[0]?.banner4}
              alt=""
            />
            <img
              width={"20%"}
              style={{ margin: "15px" }}
              src={categoryDevelopers[0]?.banner5}
              alt=""
            />
            <img
              width={"35%"}
              style={{ margin: "15px" }}
              src={categoryDevelopers[0]?.banner6}
              alt=""
            />
          </Grid>
        </Grid>
